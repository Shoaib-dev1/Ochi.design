  ...
  const reviews = [
    {
      ...
      services: ['start the project', 'Sales Deck'],
      image:
  ...
  return (
    <div className="w-full">
      ...
      {reviews.map((review, index) => (
        <div
          key={review.id}
          className=" border-zinc-600 border-t-[1px]  py-4 px-15">
          <div
          ...
          <div
            ...
            <div className="flex items-center justify-center gap-60">
              ...
              <div className=" min-w-2 flex flex-col items-start  gap-3  mb-20  ">
                ...
                <div className="landing-button flex items-center gap-2">
               <div key={i} className=" landing-bt uppercase font-light text-md  tracking-tight border-[1px] border-zinc-500 rounded-full w-[11vw] h-[4.5vh] text-center cursor-pointer ">
        ...
        <div className="cardcontainer w-1/2 h-[66vh]">
          <div className="card relative flex items-center justify-center h-full bg-[#004d43] rounded-xl">
            <img
              ...
              alt="" />
            <button className="absolute  py-1 px-3 border-[1px] border-[#cdea68] rounded-full left-10 bottom-10 ">
              &copy;2019-2025
            </button>
          </div>
        </div>
        <div className="cardcontainer h-[66vh] flex gap-5 w-1/2 ] ">
          <div className=" w-1/2 h-full relative flex flex-col items-center justify-center  bg-[#212121] rounded-xl ">
            <img
              className=""
              src="https://ochi.design/wp-content/uploads/2022/04/logo002.svg"
              alt="" />
            <button className=" animated-button absolute  py-1 px-3 border-[1px] border-zinc-100 rounded-full uppercase right-[12%]  top-[33%] ">
              <span>Rating5.0 On Clutch</span>
            </button>
          ...
          <div className=" w-1/2 h-full relative flex flex-col items-center justify-center  bg-[#212121] rounded-xl ">
            <img
              ...
              alt=""/>
            <button className=" animated-button absolute  py-1 px-3 border-[1px] border-zinc-100 rounded-full uppercase right-[9%] top-[26%] ">
              <span>Business Bootcamp Alumni</span>
            </button>
          </div>
        </div>
      </div>
