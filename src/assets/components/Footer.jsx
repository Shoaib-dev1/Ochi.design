...
const Footer = () => {
  return (
    <div className='flex gap-5 w-full h-full rounded-tl-2xl rounded-tr-2xl bg-zinc-800 '>
            <div className='w-1/2  flex flex-col justify-between pt-30 px-9'>
               <div>
                    <h1 className='text-8xl uppercase font-bold  leading-[11vh] -tracking-[0.5vw]'>Eye-</h1>
                    <h1 className='text-8xl uppercase font-bold  leading-[11vh] -tracking-[0.5vw]'>Opning</h1>
               </div>
                <div className='mb-5'>
            ...
            <div className='w-1/2 pt-30 px-9'>
                 ...
                 <div className='flex justify-between '>
                    ...
                    <div className='flex flex-col mt-10'>
                            <h4 className='text-2xl mb-5'>E:</h4>
                            <a className='block text-[1.1vw] font-light tracking-tight ' href="#">hello@ochi.design</a>
                    </div>
