...
<> 
    ...
    <div className="bg-[#cdea68]  pt-20 text-neutral-800  rounded-tl-2xl rounded-tr-2xl  ">
          <div className='pl-10'>
        ...
        <div className='f-full flex gap-5 border-t-[1px] border-zinc-500 mt-10 mr-10'>
              <div className='w-1/2'>
                    ...
                    <div className='About-button'>
                      <button className='animated-button-2 bg-[#202020] w1/2 rounded-4xl py-4 px-7 ml-15 mt-3 font-semibold uppercase text-white flex gap-5'>Read More
